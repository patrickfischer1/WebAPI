...
public class DataAccessConfig {
    ...
    public DataSource primaryDataSource() {
     ...
     pc.setDefaultAutoCommit(autoCommit);*/
        ...
        supportedDrivers = new String[]{"org.postgresql.Driver", "com.microsoft.sqlserver.jdbc.SQLServerDriver", "oracle.jdbc.driver.OracleDriver", "com.amazon.redshift.jdbc.Driver", "com.cloudera.impala.jdbc4.Driver"};
